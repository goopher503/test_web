...
//制作完整的Request
func (r *Request) MakeMobRequest() error {
	var err error
	if r.BidRequest, err = InitMobRequest(); err != nil {
		return err
	}
	r.FillMobRequest()
	return nil
...
//随机生成数据填充Request
func InitMobRequest() (*openrtb.BidRequest, error) {
...
func MakeApp(a *openrtb.App,seed *rand.Rand) {
	...
	//需要填充的项
	var id, name, domain, keywords string
	var cat []string
...
func MakeAppPublisher(p *openrtb.Publisher) {
	var id, name string
	id = "1100002442"
	name = "OpenX"
...
func MakeSitePublisher(p *openrtb.Publisher) {
	var id, name string
	id = "1100002442"
	name = "OpenX"
...
func MakeExt(e *openrtb.MfExt, d *openrtb.Device) {
